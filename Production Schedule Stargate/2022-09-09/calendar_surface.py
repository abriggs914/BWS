...
class CalendarSurface(tkinter.Canvas):
    ...
    def revert_colour(self, rc):
        ...
        tests = [self.tile_properties[r][c]["t1_tag"], self.tile_properties[r][c]["t2_tag"], self.tile_properties[r][c]["t3_tag"], self.tile_properties[r][c]["t4_tag"], self.tile_properties[r][c]["t5_tag"]]
        tile_colour, outline_colour, active_fill_colour, active_outline_colour, font_colour = self.calc_colours(r, c)
        ...
        for t in tests:
            self.itemconfigure(t, fill=tile_colour, activefill=active_fill_colour)
