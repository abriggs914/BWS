...
-- SG100276
UPDATE [BWSdb].[dbo].[OrdersV2] SET [Available Date] = '2022-01-24 00:00:00' WHERE [SGQuote] = 'SG100276';
UPDATE [Stargatedb].[dbo].[dtProductionScheduleV2] SET [JobFinishDate] = '2022-01-24 00:00:00', [JobStartLine] = 'T5' WHERE [SGQuote] = 'SG100276'
-- SG100400
