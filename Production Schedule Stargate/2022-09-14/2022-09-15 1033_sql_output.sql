...
-- SG100121
UPDATE [BWSdb].[dbo].[OrdersV2] SET [Available Date] = '2022-01-03 00:00:00' WHERE [SGQuote] = 'SG100121';
UPDATE [Stargatedb].[dbo].[dtProductionScheduleV2] SET [JobFinishDate] = '2022-01-03 00:00:00', [JobStartLine] = 'T1' WHERE [SGQuote] = 'SG100121'
-- SG100400
