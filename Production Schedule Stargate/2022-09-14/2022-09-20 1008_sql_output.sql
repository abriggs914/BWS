...
-- SG100122
UPDATE [BWSdb].[dbo].[OrdersV2] SET [Available Date] = '2022-01-10 00:00:00' WHERE [SGQuote] = 'SG100122';
UPDATE [Stargatedb].[dbo].[dtProductionScheduleV2] SET [JobFinishDate] = '2022-01-10 00:00:00', [JobStartLine] = 'T2' WHERE [SGQuote] = 'SG100122'
-- SG100291
