...
-- SG100276
UPDATE [BWSdb].[dbo].[OrdersV2] SET [Available Date] = 'NaT' WHERE [SGQuote] = 'SG100276';
UPDATE [Stargatedb].[dbo].[dtProductionScheduleV2] SET [JobFinishDate] = 'NaT', [JobStartLine] = 'T5' WHERE [SGQuote] = 'SG100276'
-- SG100400
