...
/****** Object:  Trigger [dbo].[tr_UpdateINV_WarehouseLayout_HawkinsShelvesHistory]    Script Date: 2026-01-07 12:10:32 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE TRIGGER [dbo].[tr_UpdateINV_WarehouseLayout_HawkinsShelvesHistory] 
...
BEGIN
	...
	INSERT INTO
        [BWSdb].[dbo].[hist_INV_WarehouseLayout_HawkinsShelves]
    (
        [NestLevel],
        [ModifiedID],
        [ModifiedBy],
