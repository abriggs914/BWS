...
/****** Object:  Trigger [dbo].[tr_UpdateINV_WarehouseShelfSections_MontanaHistory]    Script Date: 2026-01-20 11:46:53 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
-- Author:		<Avery Briggs>
-- Create today:	<2026-01-20 11:46:53>
-- Description:	<Maintain History Table>
-- =============================================
CREATE TRIGGER [dbo].[tr_UpdateINV_WarehouseShelfSections_MontanaHistory] 
...
BEGIN
	...
	INSERT INTO
        [BWSdb].[dbo].[hist_INV_WarehouseShelfSections_Montana]
    (
        [NestLevel],
        [ModifiedID],
        [ModifiedBy],
