...
INNER JOIN
    [SysproCompanyA].[dbo].[WipMaster]
ON
    WipMaster.[Job] = CAST(dtProductionSchedule.[WO#] AS VARCHAR(10))
INNER JOIN
	[SysproCompanyA].[dbo].InvMaster 
ON
