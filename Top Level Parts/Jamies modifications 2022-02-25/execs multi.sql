...
EXEC [SysproCompanyA].[dbo].[sp_TopLevelWOReportJamieMulti] @WO='10014747;10014748', @INCOMPLETEONLY=0;


EXEC [SysproCompanyA].[dbo].[sp_TopLevelWOReportJamieMulti] @WO='10015524', @INCOMPLETEONLY=0, @PARTCATEGORY='M;B;S', @OPERATION='04;05';