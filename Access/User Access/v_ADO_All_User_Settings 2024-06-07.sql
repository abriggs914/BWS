...
/****** Object:  View [dbo].[v_ADO_All_User_Settings]    Script Date: 2024-06-04 12:19:00 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dbo].[v_ADO_All_User_Settings] AS

	SELECT
		CAST([CUS_CustomerID] AS INT) AS [CUS_CustomerID]
		,[CUS_Name]
		,[CUS_Department]
		,[CUS_Company]
		,[CUS_Email]
	...
	/*ORDER BY
		(CASE WHEN [CUS_Name] = 'Avery Briggs' THEN 0 ELSE 1 END)
	*/
	/*
	ORDER BY
		[CUS_Name]
