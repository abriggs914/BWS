...
/****** Object:  Trigger [dbo].[tr_ADPValidUsersUpdateActive]    Script Date: 2023-06-01 12:01:58 PM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE TRIGGER [dbo].[tr_CLKValidUsersUpdateActive]
   ON  [dbo].[CLK Valid Users]
   AFTER INSERT, UPDATE
AS 
BEGIN
...
ALTER TABLE [dbo].[ADP Valid Users] ENABLE TRIGGER [tr_ADPValidUsersUpdateActive]
GO
