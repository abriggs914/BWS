...
FROM (
	SELECT
		ISNULL([YC].[Name],
			...
			ISNULL([Y15].[Name], ISNULL([Y14].[Name], ISNULL([Y13].[Name], ISNULL([Y12].[Name], ISNULL([Y11].[Name], [Y10].[Name])))))
			)))))
			)))))
			)))))
		) AS [Name]
	...
	FULL JOIN
		@empsYear12 [Y12]
	ON
		ISNULL([Y11].[Name], [Y10].[Name]) = [Y12].[Name]
	FULL JOIN
		@empsYear13 [Y13]
	ON
		ISNULL([Y12].[Name], ISNULL([Y11].[Name], [Y10].[Name])) = [Y13].[Name]
	FULL JOIN
		@empsYear14 [Y14]
	ON
		ISNULL([Y13].[Name], ISNULL([Y12].[Name], ISNULL([Y11].[Name], [Y10].[Name]))) = [Y14].[Name]
	FULL JOIN
		@empsYear15 [Y15]
	ON
		ISNULL([Y14].[Name], ISNULL([Y13].[Name], ISNULL([Y12].[Name], ISNULL([Y11].[Name], [Y10].[Name])))) = [Y15].[Name]
	FULL JOIN
		@empsYear16 [Y16]
	ON
		ISNULL([Y15].[Name], ISNULL([Y14].[Name], ISNULL([Y13].[Name], ISNULL([Y12].[Name], ISNULL([Y11].[Name], [Y10].[Name]))))) = [Y16].[Name]
	FULL JOIN
		@empsYear17 [Y17]
	ON
		ISNULL([Y16].[Name],
