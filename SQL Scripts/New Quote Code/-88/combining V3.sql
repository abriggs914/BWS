USE [BWSdb]
GO
--/****** Object:  StoredProcedure [dbo].[sp_NewQuoteReport V3]    Script Date: 2021-10-19 2:54:15 PM ******/
--SET ANSI_NULLS ON
--GO
...
DECLARE	@quote varchar(8), @quoterev int
SET @quote = 'SG100403'
SET @quoterev = 0;
--AS
--BEGIN
	...
	--Code -88 - infinite find and replace array (minics code 0)
			...
			*/
			...
			--select statement
			select OrdersV2.SGQuote, @quoterev as Revision#, ProductsV2.Class, ProductsV2.Model, OrdersV2.[Model No], [Special Instructions], PDD, [Prom Drawing],
			[COMPANY NAME], DealersV2_SalesPersonBranch.Branch, DealersV2_SalesPeople.[Sales Person] as DealersV2P, 
			OrdersV2.WO#, [Serial Number], [Sales Order#], [Purchase Order], [PO Date], [Delivery Date],
	...
	--Code -88 - infinite find and replace array (minics code 0)
			...
			*/
			...
			--select statement
			select OrdersV2_RevHistory.SGQuote, Rev# as Revision#, ProductsV2.Class, ProductsV2.Model, OrdersV2_RevHistory.[Model No], [Special Instructions], PDD, [Prom Drawing],
			[COMPANY NAME], DealersV2_SalesPersonBranch.Branch, DealersV2_SalesPeople.[Sales Person] as DealersV2P, 
			OrdersV2_RevHistory.WO#, [Serial Number], [Sales Order#], [Purchase Order], [PO Date], [Delivery Date],
