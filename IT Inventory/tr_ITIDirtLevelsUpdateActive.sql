USE [BWSdb]
GO
/****** Object:  Trigger [dbo].[tr_ADPValidUsersUpdateActive]    Script Date: 2023-09-08 3:04:47 PM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE TRIGGER [dbo].[tr_ITIDirtLevelsUpdateActive]
   ON  [dbo].[ITI Dirt Levels]
   AFTER INSERT, UPDATE
AS 
BEGIN
