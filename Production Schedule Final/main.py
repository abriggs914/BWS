...
if __name__ == "__main__":
    pscf = PSCCalendarFrame(width_p=1500, height_p=600, title_p="Production Schedule Editor", max_tile_w=200, max_tile_h=200, max_n_zoomed_cols=1, max_n_zoomed_rows=1, max_n_selected=1, border_width=5)
