...
class PSCalendar2:
    ...
    LOG_KEYS = {
        "Swap CalendarTile": {"params": ["tile_a", "tile_b"], "func": "undo_swap_tiles"},
        "Deleting CalendarTile": {"params": [], "func": None},
        "Inserting CalendarTile": {"params": [], "func": None},
        "Shifting CalendarTiles": {"params": [], "func":  None},
    ...
    def delete(self, tile_in):
        ...
        self.deleted_tiles.append(tile_in)
        ser = tile_in.ser
        i = tile_in.i
        j = tile_in.j
        line = tile_in.line
    ...
    def undo_swap_tiles(self, tile_a, tile_b):
        tile_a = self.tiles[calendar_tile_from_repr(tile_a)]
        tile_b = self.tiles[calendar_tile_from_repr(tile_b)]
        self.do_swap(tile_a, tile_b)
    ...
    def do_swap(self, tile_a, tile_b):
    ...
    def get_edited(self):
        return [tile for tile in self.tiles if tile.is_edited()]
