USE [BWSdb]
GO
/****** Object:  Trigger [dbo].[tr_ITFFlagsUpdateActive]    Script Date: 2024-02-15 6:48:48 PM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE TRIGGER [dbo].[tr_ITRRequestReminderImportanceCodesUpdateActive]
   ON  [dbo].[ITR Request Reminder Importance Codes]
   AFTER INSERT, UPDATE
AS 
BEGIN
