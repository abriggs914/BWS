...
# def check_2_dates():
#     print(f"VALS: <{filter_start_date}>")
...
# <<<<<<< HEAD
    ...
    # filter_start_date = st.multiselect(
    #     'Start Date Range:',
    #     options=df["StartDate"].unique(),
    #     default=df["StartDate"].unique(),
...
# <<<<<<< HEAD
    ...
    # prog = 0
    # balloons_progress_bar = st.progress(prog)
    #
