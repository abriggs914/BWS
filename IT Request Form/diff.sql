...
ON
	...
	OR 1=(CASE 
			WHEN LOWER([T1].[Name]) = 'sherwood, jeffrey' AND (LOWER([T1].[Name]) COLLATE DATABASE_DEFAULT = LOWER(([@SRC].[2nd Name] + ', ' + 'jeffrey')) COLLATE DATABASE_DEFAULT OR LOWER([T1].[Name]) COLLATE DATABASE_DEFAULT = LOWER(([@SRC].[2nd Name] + ' ' + 'jeffrey')) COLLATE DATABASE_DEFAULT OR LOWER([T1].[Name]) COLLATE DATABASE_DEFAULT = LOWER(([@SRC].[2nd Name] + ',' + 'jeffrey')) COLLATE DATABASE_DEFAULT) THEN
						1
					ELSE
						0
					END)
	...
	OR 1=(CASE 
			WHEN LOWER([T1].[Name]) = 'mertherell, joanna' AND (LOWER([T1].[Name]) COLLATE DATABASE_DEFAULT = LOWER(('mertherell' + ', ' + [@SRC].[1st Name])) COLLATE DATABASE_DEFAULT OR LOWER([T1].[Name]) COLLATE DATABASE_DEFAULT = LOWER(('mertherell' + ', ' + [@SRC].[1st Name])) COLLATE DATABASE_DEFAULT OR LOWER([T1].[Name]) COLLATE DATABASE_DEFAULT = LOWER(('mertherell' + ', ' + [@SRC].[1st Name])) COLLATE DATABASE_DEFAULT) THEN
						1
					ELSE
						0
					END)
	...
	OR 1=(CASE 
			WHEN LOWER([T1].[Name]) = 'gillas, matthew' AND (LOWER([T1].[Name]) COLLATE DATABASE_DEFAULT = LOWER(('gillas' + ', ' + [@SRC].[1st Name])) COLLATE DATABASE_DEFAULT OR LOWER([T1].[Name]) COLLATE DATABASE_DEFAULT = LOWER(('gillas' + ', ' + [@SRC].[1st Name])) COLLATE DATABASE_DEFAULT OR LOWER([T1].[Name]) COLLATE DATABASE_DEFAULT = LOWER(('gillas' + ', ' + [@SRC].[1st Name])) COLLATE DATABASE_DEFAULT) THEN
						1
					ELSE
						0
					END)
	...
	--OR 1=(CASE 
	--		WHEN LOWER([T1].[Name]) = 'guest, michael' AND (LOWER([T1].[Name]) COLLATE DATABASE_DEFAULT = LOWER(([@SRC].[2nd Name] + ', ' + 'michael')) COLLATE DATABASE_DEFAULT OR LOWER([T1].[Name]) COLLATE DATABASE_DEFAULT = LOWER(([@SRC].[2nd Name] + ', ' + 'michael')) COLLATE DATABASE_DEFAULT OR LOWER([T1].[Name]) COLLATE DATABASE_DEFAULT = LOWER(([@SRC].[2nd Name] + ', ' + 'michael')) COLLATE DATABASE_DEFAULT) THEN
	--					1
	--				ELSE
	--					0
	--				END)
	...
	OR 1=(CASE 
			WHEN LOWER([T1].[Name]) = 'nassar, yassin' AND (LOWER([T1].[Name]) COLLATE DATABASE_DEFAULT = LOWER(('nassar' + ', ' + [@SRC].[1st Name])) COLLATE DATABASE_DEFAULT OR LOWER([T1].[Name]) COLLATE DATABASE_DEFAULT = LOWER(('nassar' + ', ' + [@SRC].[1st Name])) COLLATE DATABASE_DEFAULT OR LOWER([T1].[Name]) COLLATE DATABASE_DEFAULT = LOWER(('nassar' + ', ' + [@SRC].[1st Name])) COLLATE DATABASE_DEFAULT) THEN
						1
					ELSE
						0
					END)
	...
	OR 1=(CASE 
			WHEN LOWER([T1].[Name]) = 'hawlings, roland' AND (LOWER([T1].[Name]) COLLATE DATABASE_DEFAULT = LOWER(('hawling' + ', ' + [@SRC].[1st Name])) COLLATE DATABASE_DEFAULT OR LOWER([T1].[Name]) COLLATE DATABASE_DEFAULT = LOWER(('hawling' + ', ' + [@SRC].[1st Name])) COLLATE DATABASE_DEFAULT OR LOWER([T1].[Name]) COLLATE DATABASE_DEFAULT = LOWER(('hawling' + ', ' + [@SRC].[1st Name])) COLLATE DATABASE_DEFAULT) THEN
						1
					ELSE
						0
					END)
