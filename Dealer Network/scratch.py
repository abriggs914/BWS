...
THIS_VAR_MUST_BE_FALSE_SO_AS_TO_NOT_OVERWRITE_ADDRESS_FILES = False
#
...
if THIS_VAR_MUST_BE_FALSE_SO_AS_TO_NOT_OVERWRITE_ADDRESS_FILES:
    dealerships = {}
    data = pd.DataFrame({
...
if THIS_VAR_MUST_BE_FALSE_SO_AS_TO_NOT_OVERWRITE_ADDRESS_FILES:
    with open("dealers_info.csv", "r") as f, open("out.txt", "w") as o, open("addresses.txt", "w") as a:
