...
def address_to_coords(address):
    try:
        location = Nominatim(user_agent="GetLoc").geocode(address)
        if location:
...
if __name__ == '__main__':
    ...
    for addr in (
            ...
            # "Centreville, Virgina, USA",
            # "Centreville, Virgina, United States of America",
            ...
            "Ostervala, SWE",
            "Ostervala, SWEDEN",
            "Saint-Jerome, Quebec, CAN",
            "Richmond Hill, Ontario, CAN"
    ):
        print(f"{addr=}, {address_to_coords(addr)=}")
