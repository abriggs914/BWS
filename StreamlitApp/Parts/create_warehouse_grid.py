...
# @st.cache_data(ttl=60*60, show_spinner=True)
# def load_layout_data(pth_layout: str, copy_from_path: str | None = None) -> dict[str, pd.DataFrame]:
# 	sheets = ["Layout", "Legend"]
# 	dfs: dict = pd.read_excel(
# 		pth_layout,
# 		sheet_name=sheets,
# 	)
# 	sheets.extend(["ShelfSections", "Shelves"])
# 	to_copy = []
# 	for sht in sheets:
# 		if sht not in dfs:
# 			to_copy.append(sht)
# 	if to_copy:
# 		dfs.update(pd.read_excel(
# 			copy_from_path,
# 			to_copy
# 		))
# 	return dfs
...
pth_layout_h: str = r"G:\IT\Network Port Layout\BWS\Hawkins Warehouse Layout Rev3 202601050840.xlsx"
pth_layout_m: str = r"G:\IT\Network Port Layout\BWS\Montana Warehouse Layout.xlsx"

# df_data = load_layout_data(pth_layout_m, copy_from_path=pth_layout_h)
...
clicked = plotly_events(fig, click_event=True, hover_event=False, select_event=False, override_height=1000)
