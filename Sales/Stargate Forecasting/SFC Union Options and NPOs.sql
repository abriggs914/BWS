...
--SELECT
--	[OO].[ID] AS [OrderOptionsID]
--	,[OO].[Quote Date] AS [OrderOptionsDateQuote]
--	,[OO].[Order Date] AS [OrderOptionsDateOrder]
--	,[OO].[WO#] AS [OrderOptionsWO]
--	,[OO].[Quote#] AS [OrderOptionsQuote]
--	,[OO].[Option No] AS [OrderOptionsOptionNo]
--	,[OO].[Price] AS [OrderOptionsPrice]
--	,[OO].[Qty] AS [OrderOptionsQty]
--	,[OO].[Sections] AS [OrderOptionsSections]
--	,[OO].[Description] AS [OrderOptionsDescription]
--	,[OO].[Comments] AS [OrderOptionsComments]
--	,[OO].[Weight] AS [OrderOptionsWeight]
--	,[OO].[Cost] AS [OrderOptionsCost]
--	,[OO].[Material Cost] AS [OrderOptionsMaterialCost]
--	,[OO].[Machine Shop] AS [OrderOptionsMachineShop]
--	,[OO].[Steel Kit] AS [OrderOptionsSteelKit]
--	,[OO].[Axles] AS [OrderOptionsAxles]
--	,[OO].[Stakes/Bunks] AS [OrderOptionsStakesBunks]
--	,[OO].[Beam] AS [OrderOptionsBeam]
--	,[OO].[GNK] AS [OrderOptionsGNK]
--	,[OO].[Parts] AS [OrderOptionsParts]
--	,[OO].[Line] AS [OrderOptionsLine]
--	,[OO].[Step 1] AS [OrderOptionsStep1]
--	,[OO].[Step 2] AS [OrderOptionsStep2]
--	,[OO].[Blast] AS [OrderOptionsBlast]
--	,[OO].[Paint] AS [OrderOptionsPaint]
--	,[OO].[Finish] AS [OrderOptionsFinish]
--	,[OO].[Finish - GNK] AS [OrderOptionsFinish-GNK]
--	,[OO].[Final Assembly] AS [OrderOptionsFinalAssembly]
--	,[OO].[Tire Assembly] AS [OrderOptionsTireAssembly]
--	,[OO].[Shipping] AS [OrderOptionsShipping]
--	,[OO].[Start Date] AS [OrderOptionsDateStart]
--	,[OO].[End Date] AS [OrderOptionsDateEnd]
--	,[OO].[SortSe] AS [OrderOptionsSortSe]
--	,[OO].[Width] AS [OrderOptionsWidth]
--	,[OO].[Spread] AS [OrderOptionsSpread]
--	,[OO].[Draw/Part#] AS [OrderOptionsDrawPart]
--	,[OO].[OptionInfo] AS [OrderOptionsOptionInfo]
--	,[OO].[OptionPromptFlag] AS [OrderOptionsOptionPromptFlag]
--	,[OO].[OptionPrompt] AS [OrderOptionsOptionPrompt]
--	,[OO].[OptionConfigInfo] AS [OrderOptionsOptionConfigInfo]
--	,[OO].[ordopt_timestamp] AS [OrderOptionsordopt_timestamp]
--	,[OO].[Are WO Specs Different?] AS [OrderOptionsAreWOSpecsDifferent]
--	,[OO].[Comments V2] AS [OrderOptionsCommentsV2]
--	,[CW].[ID] AS [CustomWork_ID]
--	,[CW].[Quote Date] AS [CustomWork_DateQuote]
--	,[CW].[Quote#] AS [CustomWork_Quote]
