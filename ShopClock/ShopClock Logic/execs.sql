...
DECLARE @test_range AS BIT, @test_select AS BIT, @test_stargate_shift_1 AS BIT, @test_stargate_shift_2 AS BIT, @test_stargate_shift_3 AS BIT;
SET @test_range = 0;
SET @test_select = 0;
SET @test_stargate_shift_1 = 1;
SET @test_stargate_shift_2 = 1;
SET @test_stargate_shift_3 = 1;
