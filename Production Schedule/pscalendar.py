...
class PSCalendar:
    ...
    border_width = property(get_border_width, set_border_width, del_border_width, "Border width of the inner canvas of this calendar. Used to checker the calendar tiles.")
