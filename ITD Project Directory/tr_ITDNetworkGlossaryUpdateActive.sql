...
/****** Object:  Trigger [dbo].[tr_ITFFlagsUpdateActive]    Script Date: 2024-01-08 4:12:12 PM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE TRIGGER [dbo].[tr_ITDNetworkGlossaryUpdateActive]
   ON  [dbo].[ITD Network Glossary]
   AFTER INSERT, UPDATE
AS 
BEGIN
